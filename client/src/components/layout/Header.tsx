        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <Link href="/" className="mb-4 md:mb-0">
            <div className="flex flex-col items-center md:items-start">
              <h1 className="font-['Playfair_Display'] text-3xl md:text-4xl font-bold text-primary">कला by Harvansh</h1>
              <p className="text-xs text-gray-500 italic">Crafting Homes, Curating Stories</p>
            </div>
          </Link>
